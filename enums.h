...
enum ConditionType_t {
	...
	CONDITION_STUN = 1 << 26,
	CONDITION_IMMORTAL = 1 << 27,
	CONDITION_PROTECTED = 1 << 28,
	CONDITION_MUTEDSPELL = 1 << 29,
	CONDITION_BUFF_MELEE_DAMAGE = 1 << 29
};
...
enum transforms_t : uint64_t {
    ...
    TRANSFORMS_FIRST = TRANSFORMS_1,
    TRANSFORMS_LAST = TRANSFORMS_10
};
