...
class LuaScriptInterface
{
	...
	private:
		...
		static int luaItemSetUniqueId(lua_State* L);
		...
		static int luaPlayerGetLootRate(lua_State* L);
		static int luaPlayerSetLootRate(lua_State* L);
		...
		static int luaPlayerGetAdditionalAttackSpeed(lua_State* L);
		static int luaPlayerSetAdditionalAttackSpeed(lua_State* L);

		static int luaDoPlayerAddStunDuration(lua_State* L);
		static int luaPlayerGetStunStatus(lua_State* L);
		...
		static int luaMonsterTypeIsSagaMonster(lua_State* L);
