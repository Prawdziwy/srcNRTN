...
bool IOLoginData::loadPlayerById(Player* player, uint32_t id)
{
	...
	query.append("SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `blessingDrop`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `spells`, `storages`, `skulltime`, `skull`, `town_id`, `balance`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `direction`, `transform`, `special_rate_loot` FROM `players` WHERE `id` = ").appendInt(id);
...
bool IOLoginData::loadPlayerByName(Player* player, const std::string& name)
{
	...
	query.append("SELECT `id`, `name`, `account_id`, `group_id`, `sex`, `vocation`, `experience`, `level`, `maglevel`, `health`, `healthmax`, `blessings`, `blessingDrop`, `mana`, `manamax`, `manaspent`, `soul`, `lookbody`, `lookfeet`, `lookhead`, `looklegs`, `looktype`, `lookaddons`, `posx`, `posy`, `posz`, `cap`, `lastlogin`, `lastlogout`, `lastip`, `conditions`, `spells`, `storages`, `skulltime`, `skull`, `town_id`, `balance`, `stamina`, `skill_fist`, `skill_fist_tries`, `skill_club`, `skill_club_tries`, `skill_sword`, `skill_sword_tries`, `skill_axe`, `skill_axe_tries`, `skill_dist`, `skill_dist_tries`, `skill_shielding`, `skill_shielding_tries`, `skill_fishing`, `skill_fishing_tries`, `direction`, `transform`, `special_rate_loot` FROM `players` WHERE `name` = ").append(escapedName);
	return loadPlayer(player, g_database.storeQuery(query));
}
...
bool IOLoginData::loadPlayer(Player* player, DBResult_ptr result)
{
	...
	player->blessingDrop = result->getNumber<uint16_t>("blessingDrop");
...
bool IOLoginData::savePlayer(Player* player)
{
	...
	query.append(",`special_rate_loot` = ").appendInt(player->getSpecialLootRate());
	query.append(",`transform` = ").appendInt(player->getTransform());
	...
	query.append(",`blessingDrop` = ").appendInt(player->blessingDrop);
...
{
	std::stringExtended query(static_cast<size_t>(256));
	query.append("INSERT IGNORE INTO `account_viplist` (`account_id`, `player_id`) VALUES (").appendInt(accountId).append(1, ',').appendInt(guid).append(1, ')');
	g_database.executeQuery(query);
}
