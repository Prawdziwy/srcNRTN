...
const uint16_t TRANSFORM_STORAGE = 995;
const uint16_t TRANSFORM_CONFIG_STORAGE = 996;

const uint64_t CHANNEL_RVR = 2;

enum TransformDeath_t
{
	DEATH_REVERT_TO_BASE = 0,
	DEATH_REVERT,
	DEATH_NO_REVERT
};

enum TransformAttributes_t
{
	TRANSFORM_HEALTH = 0,
	TRANSFORM_KI,
	TRANSFORM_MELEE,
	TRANSFORM_FIRST = TRANSFORM_MELEE,
	TRANSFORM_KI_EFF,
	TRANSFORM_DEFENSE,
	TRANSFORM_SPEED,
	TRANSFORM_LAST = TRANSFORM_SPEED,
	TRANSFORM_HEALTH_CONDITION,
	TRANSFORM_KI_CONDITION,
	TRANSFORM_CONDITION = 100
};
